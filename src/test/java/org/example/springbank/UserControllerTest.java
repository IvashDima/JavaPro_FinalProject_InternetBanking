...
public class UserControllerTest {
    ...
    @Mock private ClientService clientMockService;
    @Mock private UserService userMockService;
    ...
    void setUp() {
        ...
        userController = new UserController(userMockService, encoder, null);
        clientController = new ClientController(clientMockService, null);
        mockMvc =
                MockMvcBuilders.standaloneSetup(userController, clientController)
    ...
    public void shouldReturnListOfClients_whenGetClientsController() throws Exception {
        ...
        mockMvc.perform(get("/client/api").contentType(MediaType.APPLICATION_JSON))
    ...
    public void shouldReturnClient_whenGetClientByNameExistsController() throws Exception {
        ...
        mockMvc.perform(get("/client/api/name/Dima").contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void shouldReturnListOfUsers_whenGetUsersController() throws Exception {
        ...
        mockMvc.perform(get("/user/api").contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0].name").value("Dima"))
                .andExpect(jsonPath("$[1].name").value("Iryna"));
    }
    ...
    public void shouldReturnUser_whenGetUserByEmailExistsController() throws Exception {
        ...
        mockMvc.perform(
                        get("/user/api/email/dima@test.com")
